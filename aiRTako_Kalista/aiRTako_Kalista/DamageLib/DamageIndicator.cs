namespace aiRTako_Kalista.DamageLib
{
    ...
    internal static class DamageIndicator
    {
        ...
        internal static void AddToMenu(Menu mainMenu, DamageToUnitDelegate Damage = null)
        {
            ...
            mainMenu.Add("DrawComboDamage", new CheckBox("Draw E Damage"));
            mainMenu.Add("DrawFillDamage", new CheckBox("Draw E Damage Fill Color"));

            DamageToUnit = Damage ?? DamageCalculate.GetRealEDamage;
